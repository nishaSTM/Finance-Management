...
public class BankBalanceActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		//Intent intent=getIntent().getBundleExtra(name);
		 ArrayList<Operation> questions = new ArrayList<Operation>();
		  questions = (ArrayList<Operation>) getIntent().getSerializableExtra("key");
		...
		mainList.setAdapter(new UsersAdapter(this,questions));
	}
